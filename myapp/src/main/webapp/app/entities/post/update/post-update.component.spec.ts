...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 7394 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 14793 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 26687 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 19871 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 11932 };
      post.blog = blog;
      const tag: ITag = { id: 15869 };
      post.tags = [tag];
