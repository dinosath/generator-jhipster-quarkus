...
describe('Blog e2e test', () => {
  ...
  const blogSample = { name: 'tusk', handle: 'inside ack' };
  ...
  describe('new Blog page', () => {
    ...
    it('should create an instance of Blog', () => {
      cy.get(`[data-cy="name"]`).type('behind amused');
      cy.get(`[data-cy="name"]`).should('have.value', 'behind amused');

      cy.get(`[data-cy="handle"]`).type('than cheery');
      cy.get(`[data-cy="handle"]`).should('have.value', 'than cheery');
