...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'justly provided', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-07-31T13:35:32.925Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('sometimes');
      cy.get(`[data-cy="title"]`).should('have.value', 'sometimes');
      ...
      cy.get(`[data-cy="date"]`).type('2024-07-31T11:32');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-07-31T11:32');
